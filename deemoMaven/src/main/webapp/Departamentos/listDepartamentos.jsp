...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <a class="btn btn-danger" href="index.jsp">Regresar al index</a>
            </div>
                    ...
                    <tbody>
                        <c:forEach var="departamento" items="${listDep}">
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-success" href="DepartamentoServletController?action=edit&id=<c:out value="${departamento.id}"></c:out>">Editar<a/>
