package com.criscode.deemoMaven.modelo;
...
public class Departamento {
    ...
    public Departamento(long id, String departamento_codigo, String nombre_departamento, Date fecha_hora_crea, Date fecha_hora_modifica) {
        this.id = id;
