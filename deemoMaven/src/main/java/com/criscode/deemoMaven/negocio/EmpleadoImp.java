package com.criscode.deemoMaven.negocio;

import com.criscode.deemoMaven.data.Conexion;
import com.criscode.deemoMaven.interfaz.IEmpleado;
...
if (this.getConnection()!=null) {
	...
	public void agregar(Empleado empleado2) {
