...
public class ServletEmpleadosControlador extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equalsIgnoreCase("read")) {
			...
			String Correo_electrónico=request.getParameter("txtCorreo_electrónico");
			int Teléfono=request.getIntHeader("txtTeléfono");
			...
			emp.setCorreo_electrónico(Correo_electrónico);
			emp.setTeléfono(Teléfono);
